            ...
            <div className="jumbotron jumbotron-fluid">
                <div className="container">
                    ...
                    <div className="card-group">
                        <div className="card">
                            <img src="./images/StockApp.png" className="card-img-top" alt="..." />
                        ...
                        <div className="card">
                            <img src="./images/StarwasApp.png" className="card-img-top" alt="..." />
                            <div className="card-body">
                        ...
                        <div className="card">
                            <img src="./images/WeatherApp.png" className="card-img-top" alt="..." />
                            <div className="card-body">
