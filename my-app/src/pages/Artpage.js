        ...
        <div>
            <div className="container">
                ...
                <div className="card-group">
                    <div className="card">
                        <img src="./images/Example1" className="card-img-top" alt="..." />
                    ...
                    <div className="card">
                        <img src="./images/Example2" className="card-img-top" alt="..." />
                        <div className="card-body">
                    ...
                    <div className="card">
                        <img src="./images/Example3" className="card-img-top" alt="..." />
                        <div className="card-body">
