        ...
        <div>
            <div className="container">
                ...
                <div className="card-group">
                    <div className="card">
                        <img src="./images/Example1.png" className="card-img-top" href="./Lineimages.js"/>
                    ...
                    <div className="card">
                        <img src="./images/Example2.png" className="card-img-top" href="./ColorImages.js"/>
                        <div className="card-body">
                    ...
                    <div className="card">
                        <img src="./images/Example3.png" className="card-img-top" href="./Backgroundimages.js"/>
                        <div className="card-body">
