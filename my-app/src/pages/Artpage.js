        ...
        <div>
            <div className="container">
                ...
                <div className="card-group">
                    <div className="card">
                        <img src="./images/Example1.png" className="card-img-top" onClick="./Lineimage.js"/>
                    ...
                    <div className="card">
                        <img src="./images/Example2.jpg" className="card-img-top" onClick="./ColorImages.js"/>
                        <div className="card-body">
                    ...
                    <div className="card">
                        <img src="./images/Example3.jpg" className="card-img-top" onClick="./Backgroundimages.js"/>
                        <div className="card-body">
